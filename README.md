...
### Change the number of posts in the feed
By default the plugin limits the number of entries in the feed by 10. You can change the limit via your site's config.
