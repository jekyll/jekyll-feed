...
The 10 limit should be fine for a majority of users, but if you're in a situation where you need to change the default, e.g. if you want your feed to include the last 30 items, update your config to:
