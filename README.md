...
To customize, go to your `_config.yml` and add the field `image_path_key: your.image.key`. Dots express nesting depth of the key. 
Example:
```yml
# _config.yml
...
image_path_key: "header.teaser" # assumes path is behind "teaser" key in post's front matter
```

```yml
# _posts/example-post.md
---
title: "Example for custom image path key"
header:
  teaser: /path/to/your/image.jpg
  image_alt: "Demo"
---
